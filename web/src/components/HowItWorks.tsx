    ...
    <div className="fixed inset-0 z-[180] flex items-center justify-center bg-[rgba(8,5,0,0.74)] px-4 py-8 backdrop-blur-sm">
      ...
      >
        ...
        <div className="mt-3 grid grid-cols-3 gap-2 text-center">
          {[
            { e: "💬", t: "Discuss", d: "Talk a question through together." },
            { e: "⚖️", t: "Decide", d: "Everyone rates who matters most." },
            { e: "🌸", t: "Bloom", d: "One decision, kept forever." },
          ].map((s) => (
            <div
              key={s.t}
              className="rounded-xl border border-[rgba(76,175,80,0.15)] bg-[rgba(7,13,7,0.4)] px-2 py-3"
            >
              <div className="text-2xl" aria-hidden>{s.e}</div>
              <p className="mt-1 text-sm font-medium text-ink">{s.t}</p>
              <p className="mt-0.5 hyphens-auto break-words text-xs leading-snug text-ink-soft">
                {s.d}
              </p>
            </div>
          ))}
