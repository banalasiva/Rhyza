// The app's route loader — a small golden bud, gently breathing. On-brand with
// the planting family (no heavy sprite, no ring), so a page load reads as
// "growing." Shared so every loading screen shows the same sprout; pass a label
// to set the caption.
export function BudLoader({ label = "Loading…" }: { label?: string }) {
  return (
